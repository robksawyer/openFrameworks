...
// with FFGL & openFrameworks on VisualStudio __stdcall gives problems
// perhaps there is a way to fix this without touching FFGL code.
#ifdef OF_FFGL_NOSTDCALL
typedef DWORD   FPCREATEINSTANCEGL(class CFreeFrameGLPlugin **ppOutInstance); //__stdcall
#else
